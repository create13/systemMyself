    ...
    <div class="manage-set">
      <div class="center-content">
        <div class="input-search">
          <con-inputs :setInput="companySet" :paramsData="paramsDatas" @changeColor="colorChange" @resetColor="resetColor" @searchTable="searchInfo"></con-inputs>
        </div>
...
export default {
  ...
  data () {
    return {
      ...
      stateName: '启用',
      companySet: [
        {lables: '区域公司名称', models: '', spans: 4, types: 'input'},
      ...
      formData: [
        ...
        {formType: 'input', lables: '发货查询电话', props: 'sendTel', modelData: '', types: 'text'},
        {formType: 'input', lables: '到货查询电话', props: 'arrivalTel', modelData: '', types: 'text'},
        {formType: 'input', lables: '公司电话', props: 'companyTel', modelData: '', types: 'text'}
      ],
      ruleValidate: {
        companyName: [
      ...
      columnsTable: [
        ...
        {title: '发货查询电话', key: 'sendTel'},
        {title: '到货查询电话', key: 'arrivalTel'},
        {title: '公司电话', key: 'companyTel'}
      ],
      tableData: [],
      pages: 1,
      sizes: 10
  ...
  methods: {
    ...
    getList () {
      let paramsData = {
        ...
        rows: this.sizes,
        companyId: this.$store.getters.getInfo.companyId,
        filters: JSON.stringify({companyName: null, companyTags: 4})
      };
      this.$service.http.post('winpie/api/companyByPid', paramsData, 'post')
        .then(res => {
          this.tableData = null;
      ...
      this.$refs[name].validate((valid) => {
        if (valid) {
          ...
          let paramsData = {
            ...
            sendTel: this.formValidate.sendTel,
            arrivalTel: this.formValidate.arrivalTel,
            companyTel: this.formValidate.companyTel
          };
    ...
    editSubmit () {
      ...
      let params = {
        ...
        sendTel: this.editform.sendTel,
        arrivalTel: this.editform.arrivalTel,
